<template>
    ...
    >
        <div style="width: 100%;display: flex;justify-content: center;position: relative">
            <img v-drag="greet" id="drag" :src="currentImg" @mousewheel="wheel" ref="user_image" style="max-width: 850px;position: absolute"/>
        </div>
        <div style="width: 100%;display: flex;justify-content:center;position: absolute;bottom:1vh;left: 0;z-index: 999">
            <el-button icon="el-icon-refresh" circle @click.stop="rotateImage" size="small"></el-button>
        </div>
    </el-dialog>
</template>
<script>
